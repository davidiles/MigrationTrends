...
In this example, station 1 captures birds exclusively from region 2, while station 5 captures birds exclusively from region 1. Station 2 captures birds from regions 1 and 3...etc.  Note that no stations monitor birds exclusively from region 3.  The only trend information for region 3 will come from stations that simultaneously capture birds from other regions; thus, inference for this region will be somewhat less direct than for regions 1 and 2.
...
peak.migration <- 20 # Date of peak migration at each station
sd.migration <- 6
